...
from nookipedia.config import DB_KEYS, FISH_LIMIT
...
router = Blueprint("fish", __name__)


# All New Horizons fish
@router.route("/nh/fish", methods=["GET"])
def get_nh_fish_all():
    ...
    if request.args.get("excludedetails") == "true":
        ...
        fields = generate_fields(
            ...
            "tank_length",
            "time",
            "time_n_availability=time_n_months",
            "time_s_availability=time_s_months",
            "time2",
            "time2_n_availability=time2_n_months",
            "time2_s_availability=time2_s_months",
            "n_availability",
            "n_m1",
            "n_m2",
            "n_m3",
...
@router.route("/nh/fish/<string:fish>", methods=["GET"])
